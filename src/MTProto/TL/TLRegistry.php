...
class TLRegistry
{
    ...
    public const SCHEMA = [
        ...
        'upload.getFile#b15a9afc flags:# precise:flags.0?true offset:long limit:int = upload.File',
        'upload.file#96a18d5 type:storage.FileType mtime:int bytes:string = upload.File',
        'upload.fileCdnRedirect#f18cda44 dc_id:int file_token:string encryption_key:string encryption_iv:string cdn_file_hashes:Vector long = upload.File',
        ...
        'inputMediaUploadedDocument#5b38c6c1 flags:# nosound_video:flags.3?true force_file:flags.4?true file:InputFile mime_type:string attributes:Vector long = InputMedia',
